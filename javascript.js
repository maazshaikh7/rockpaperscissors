...
//Selects randomly between rock paper and scissors
  ...
  if (playerScore < 5 && computerScore < 5) {
    ...
    if (roundResult.textContent == "YOU WIN!") {
      roundResult.style.cssText =
        "text-shadow: 0px 0px 10px green, 0px 0px 20px green, 0px 0px 40px green, 0px 0px 80px green";
    } else if (roundResult.textContent == "YOU LOSE!") {
      roundResult.style.cssText =
        "text-shadow: 0px 0px 10px red, 0px 0px 20px red, 0px 0px 40px red, 0px 0px 80px red";
    } else if (roundResult.textContent == "TIE!") {
      roundResult.style.cssText =
        "text-shadow: 0px 0px 10px yellow, 0px 0px 20px yellow, 0px 0px 40px yellow, 0px 0px 80px yellow";
    }
    if (playerScore == 5 || computerScore == 5) {
      playerCurrentScore.textContent = playerScore;
      computerCurrentScore.textContent = computerScore;
...
function blurAndPopup() {
  ...
  if (playerScore == 5) {
    ...
    popupWindow.style.cssText =
      "box-shadow: 0px 0px 10px rgb(88, 255, 88), 0px 0px 20px rgb(88, 255, 88), 0px 0px 40px rgb(88, 255, 88), 0px 0px 80px rgb(88, 255, 88); background-color: rgb(166, 255, 166)";
  } else if (computerScore == 5) {
    gameResult.textContent = "YOU LOSE!";
    popupWindow.style.cssText =
      "box-shadow: 0px 0px 10px rgb(255, 97, 97), 0px 0px 20px rgb(255, 97, 97), 0px 0px 40px rgb(255, 97, 97), 0px 0px 80px rgb(255, 97, 97); background-color: rgb(255, 214, 214)";
  }
